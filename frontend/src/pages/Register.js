...
const strengthColor = ['', '#f5576c', '#f093fb', '#fbbf24', '#43e97b', '#00f2fe'];
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      toast.success('🎉 Account created successfully! Welcome to SmartCRM!');
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
            ...
            <motion.div
              ...
              style={{
                ...
                margin: '0 auto 20px', boxShadow: '0 8px 24px rgba(67,233,123,0.4)',
              }}>
              <FiCheck size={32} color="white" />
            </motion.div>
            <h2 style={{ color: 'white', fontSize: '22px', fontWeight: '700', margin: '0 0 8px' }}>Account Created!</h2>
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '14px' }}>Redirecting to dashboard...</p>
          </motion.div>
        ) : (
          <>
            {/* Logo */}
