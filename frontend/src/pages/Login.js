        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <FiMail
                size={16}
                style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.35)' }}
              />
              <input
                ...
                onFocus={e => { e.target.style.borderColor = 'rgba(102,126,234,0.7)'; e.target.style.background = 'rgba(255,255,255,0.1)'; }}
